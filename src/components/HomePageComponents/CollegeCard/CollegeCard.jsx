    ...
    <section>
      <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-24 lg:py-32">
        <div className="flex flex-col items-center text-center">
          <h2 className="text-3xl font-bold md:text-5xl">Featured Colleges</h2>
        ...
        <div className="grid gap-5 sm:grid-cols-2 md:grid-cols-3 md:gap-4 lg:gap-6" id="college">
          {colleges.colleges.slice(0, 3).map((college) => (
            <div
              key={college.id}
            ...
            >
              ...
              <p className="text-sm text-[#636262]">
                Research History: {college?.researchCount} research papers
              </p>
              <p className="text-sm text-[#636262]">
                Sports: {college?.sports.map((sport) => sport.name).join(", ")}
              </p>
